...
- [how to choose algorithms](00-how-to-think/how-to-choose-algorithms.md)（[中文](00-how-to-think/how-to-choose-algorithms-zh.md)）
- [how to read problems](00-how-to-think/how-to-read-problems.md)（[中文](00-how-to-think/how-to-read-problems-zh.md)）

## 01-array
- [array basics](01-array/array-basics.md)（[中文](01-array/array-basics-zh.md)）

## 02-hash-table
- [bucket technique](02-hash-table/bucket-technique.md)（[中文](02-hash-table/bucket-technique-zh.md)）
- [frequency count](02-hash-table/frequency-count.md)（[中文](02-hash-table/frequency-count-zh.md)）
- [hashing basics](02-hash-table/hashing-basics.md)（[中文](02-hash-table/hashing-basics-zh.md)）

## 03-two-pointers
- [two pointers basics](03-two-pointers/two-pointers-basics.md)（[中文](03-two-pointers/two-pointers-basics-zh.md)）

## 04-sliding-window
- [sliding window fixed](04-sliding-window/sliding-window-fixed.md)（[中文](04-sliding-window/sliding-window-fixed-zh.md)）
- [sliding window variable](04-sliding-window/sliding-window-variable.md)（[中文](04-sliding-window/sliding-window-variable-zh.md)）

## 05-binary-search
- [binary search on answer](05-binary-search/binary-search-on-answer.md)（[中文](05-binary-search/binary-search-on-answer-zh.md)）
- [binary search on array](05-binary-search/binary-search-on-array.md)（[中文](05-binary-search/binary-search-on-array-zh.md)）

## 06-prefix-sum
- [difference array](06-prefix-sum/difference-array.md)（[中文](06-prefix-sum/difference-array-zh.md)）
- [prefix sum](06-prefix-sum/prefix-sum.md)（[中文](06-prefix-sum/prefix-sum-zh.md)）

## 07-greedy
- [greedy thinking](07-greedy/greedy-thinking.md)（[中文](07-greedy/greedy-thinking-zh.md)）
- [interval greedy](07-greedy/interval-greedy.md)（[中文](07-greedy/interval-greedy-zh.md)）

## 08-dynamic-programming
- [dp introduction](08-dynamic-programming/dp-introduction.md)（[中文](08-dynamic-programming/dp-introduction-zh.md)）
- [dp on array](08-dynamic-programming/dp-on-array.md)（[中文](08-dynamic-programming/dp-on-array-zh.md)）
- [dp on strings](08-dynamic-programming/dp-on-strings.md)（[中文](08-dynamic-programming/dp-on-strings-zh.md)）
- [dp state design](08-dynamic-programming/dp-state-design.md)（[中文](08-dynamic-programming/dp-state-design-zh.md)）
- [summary](08-dynamic-programming/summary.md)（[中文](08-dynamic-programming/summary-zh.md)）
...
- [union find](09-graph/union-find.md)（[中文](09-graph/union-find-zh.md)）

## 10-how-to-choose-algorithm
- [algorithm selection guide](10-how-to-choose-algorithm/algorithm-selection-guide.md)（[中文](10-how-to-choose-algorithm/algorithm-selection-guide-zh.md)）

## 11-pattern-library
- [core patterns](11-pattern-library/core-patterns.md)（[中文](11-pattern-library/core-patterns-zh.md)）
